...
class SignInEmployee extends StatefulWidget {
  //SignInEmployee({Key key, this.title}) : super(key: key);
  ...
  @override
  SignInEmployeeState createState() => SignInEmployeeState();
}

class SignInEmployeeState extends State<SignInEmployee> {
  ...
  Widget _createAccountLabel() {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => RegisterEmployee()));
      },
      child: Container(
        margin: EdgeInsets.symmetric(vertical: 20),
